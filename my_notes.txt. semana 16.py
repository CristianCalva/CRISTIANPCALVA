...
my_notes.write("Línea 1: Estas son mis notas personales.\n")
my_notes.write("Línea 2: Recordar que el lunes empiezo examnes.\n")

# Método writelines(): escribir una lista de líneas
lineas = ["Línea 3: Otra nota.\n", "Línea 4: Llamar a Luis para coordinar la reunion.\n"]
